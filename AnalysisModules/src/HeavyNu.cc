...
bool HeavyNu::filter(edm::Event& iEvent, const edm::EventSetup& iSetup)
{
    ...
    edm::InputTag ebDigiTag("selectDigi", "selectedEcalEBDigiCollection", "RECO");
    iEvent.getByLabel(ebDigiTag, ebDigis);
    
    edm::Handle<EEDigiCollection > eeDigis;
    edm::InputTag eeDigiTag("selectDigi", "selectedEcalEEDigiCollection", "RECO");
    iEvent.getByLabel(eeDigiTag, eeDigis);
    
    edm::Handle<edm::SortedCollection<EcalRecHit,edm::StrictWeakOrdering<EcalRecHit> > > ebRecHits;
    iEvent.getByLabel("reducedEcalRecHitsEB", ebRecHits);
